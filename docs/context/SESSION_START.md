...
3. **Read the milestone index:** Open `docs/milestones/00_MASTER_INDEX.md`. Confirm the milestone sequence and source hierarchy.
...
5. **Read relevant plan sections:** Open `docs/plan/plan.md` and read the sections relevant to your task (Sections 10–11 for architecture; specific subsections as indicated by the context manifest).
