...
{
    /// <inheritdoc />
    public partial class AddIdentityTenancyAndMemberships : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    normalized_slug = table.Column<string>(type: "character varying(80)", maxLength: 80, nullable: false),
                    status = table.Column<string>(type: "character varying(16)", maxLength: 16, nullable: false),
                    onboarding_state = table.Column<string>(type: "character varying(16)", maxLength: 16, nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "ix_memberships_user_id_status_role",
                table: "memberships",
                columns: new[] { "user_id", "status", "role" });
            ...
            migrationBuilder.CreateIndex(
                name: "ix_tenants_normalized_slug",
                table: "tenants",
