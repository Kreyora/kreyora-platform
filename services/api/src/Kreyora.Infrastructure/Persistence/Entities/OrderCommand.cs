...
public sealed class OrderCommand : BaseEntity, ITenantOwned
{
    ...
    public static OrderCommand Create(string tenantId, string operation, string idempotencyKey, string requestFingerprint, string orderId) => new()
    {
